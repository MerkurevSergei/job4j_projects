...
public class HibernateRun {
    public static void main(String[] args) {
        ...
        try {
           ...
           create(
                    new Item("Learn Hibernate", "Good", Timestamp.valueOf(LocalDateTime.now())),
                    sf
            );
            create(
                    new Item("Learn Hibernate2", "Good1", Timestamp.valueOf(LocalDateTime.now())),
                    sf
            );
            Item item = create(
                    new Item("Learn Hibernate3", "Good2", Timestamp.valueOf(LocalDateTime.now())),
                    sf
            );
